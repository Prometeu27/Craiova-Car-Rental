...
public class MainController implements Initializable {
	...
	@FXML private AnchorPane offersPane;
	@FXML private AnchorPane termsPane;
	...
	public void Login(ActionEvent event) throws Exception { // metoda pentru logare 

		if (userField.getText().equals("user") && passField.getText().equals("password")) {

			Parent root = FXMLLoader.load(getClass().getResource("/application/Main.fxml"));

			Stage window = (Stage) loginButton.getScene().getWindow();
			window.setScene(new Scene(root, 900, 651));
		}
	}

	// butoanele din header-ul aplicatiei 
	// main
	@FXML
